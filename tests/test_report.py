...
class TestReport:
    ...
    def testReport_earlyPeriodHasNoEvents_expectErrorMsg(self):
        ...
        client = (
            ...
            .add_people_response(people_response)
            .add_events_response(events_response)
            .add_attendances_response(50, EventAttendancesGetResponseBuilder().build())
            .add_attendances_response(51, EventAttendancesGetResponseBuilder().build())
            .build()
        )
        accumulator = AttendanceDeclineAccumulator(client)
    ...
    def testReport_latePeriodHasNoEvents_expectErrorMsg(self):
        ...
        client = (
            ...
            .add_people_response(people_response)
            .add_events_response(events_response)
            .add_attendances_response(52, EventAttendancesGetResponseBuilder().build())
            .add_attendances_response(53, EventAttendancesGetResponseBuilder().build())
            .build()
        )
        accumulator = AttendanceDeclineAccumulator(client)
    ...
    def testReport_declineThresholdOutOfRange_expectErrorMsg(self):
        ...
        client = (
            ...
            .add_people_response(people_response)
            .add_events_response(events_response)
            .add_attendances_response(54, EventAttendancesGetResponseBuilder().build())
            .add_attendances_response(55, EventAttendancesGetResponseBuilder().build())
            .build()
        )
        accumulator = AttendanceDeclineAccumulator(client)
